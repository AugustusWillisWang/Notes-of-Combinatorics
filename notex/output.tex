...
>练习: 化简上式
    ...
    \section{4.Vandermonde恒等式
}


    
    \subsection{1. 求和 $\sum_{i\ge0}^{}i{n \choose i}={n \choose 1}+2{n \choose 2} +\cdots+n{n \choose n}= ?$
}
...
$$\sum_{i\ge0}^{}i{n \choose i}={n \choose 1}+2{n \choose 2}+\cdots+n{n \choose n}=n\cdot2^{n-1}$$  
    ...
    \subsection{2.  $(1+x)^{n}(1+x)^{m}=(1+x)^{m+n}$
}
